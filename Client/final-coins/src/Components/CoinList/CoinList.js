    ...
    ? arr.map((el) => {
        ...
        return (
          <Link
            key={el.id}
            to={{
              pathname: props.location.state?props.location.state.searchHistory?'coinPageSearch/'+el.id:"/coinPage/"+el.id:"/coinPage/"+el.id,
              state:{
                searched:props.location.state?props.location.state.searchHistory:false,
              }
            }}
          >
            <CoinSelf>
